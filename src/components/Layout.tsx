        ...
        <header className="h-[60px] flex items-center justify-between px-6 border-b border-gray-200 bg-white flex-shrink-0 z-30">
          ...
          <div className="flex items-center gap-2 flex-shrink-0 ml-4">
            ...
            <button
              ...
              className="w-9 h-9 flex items-center justify-center rounded-xl text-gray-400 hover:text-gray-700 hover:bg-gray-100 transition-all duration-200"
            ...
            <div className="relative ml-1" ref={dropdownRef}>
              ...
              >
                {user.avatar ? (
                  ...
                  <span className="text-[14px] font-black text-yellow-700">{userInitial}</span>
                )}
              </div>
              ...
              >
                ...
                <div className="px-4 py-3 border-b border-gray-100 flex items-center gap-3">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="text-xs text-gray-400 font-medium truncate mt-0.5">{user.store || 'Sunmart'}</div>
                  </div>
                </div>
                ...
                <div className="p-1.5">
                  ...
                  <button
                    ...
                    className="w-full text-left px-3 py-2 text-sm text-gray-600 hover:text-gray-900 hover:bg-gray-50 rounded-lg flex items-center transition-colors font-medium"
                  >
                    <span className="material-symbols-outlined text-[18px] mr-3 text-gray-400">person</span>
                    Hồ Sơ Cá Nhân
                  </button>
